    ...
    <div>
        ...
        {structure.map((structure) => (
          <div key={structure.strid} className="structure">
            ...
            <button className="delete" onClick={()=>handleDelete(structure.strid)}>Delete</button>
            <button className="update"><Link to = {`/updatestructure/${structure.strid}`}>Update</Link></button>
            </div>
        ))}
        <button>
